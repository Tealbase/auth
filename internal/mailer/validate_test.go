...
func TestEmalValidatorService(t *testing.T) {
	...
	//   when svc and extended checks both report email as valid
	{
		...
		err := ev.Validate(ctx, "chris.stockton@tealbase.io")
		if err != nil {
...
func TestValidateEmailExtended(t *testing.T) {
	...
	cases := []struct {
		...
		// valid (has mx record)
		{email: "a@tealbase.io"},
		{email: "support@tealbase.io"},
		{email: "chris.stockton@tealbase.io"},

		// bad format
		{email: "", err: "invalid_email_format"},
		{email: "io", err: "invalid_email_format"},
		{email: "tealbase.io", err: "invalid_email_format"},
		{email: "@tealbase.io", err: "invalid_email_format"},
		{email: "test@.tealbase.io", err: "invalid_email_format"},
		...
		{email: "test@no.such.email.host.tealbase.io", err: "invalid_email_dns"},
		...
		{email: "support@tealbase.io", timeout: time.Millisecond},
	}
